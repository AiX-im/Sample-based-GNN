...
#ifndef GNNMINI_GCN_SAMPLE_PC_MULTI_HPP
#define GNNMINI_GCN_SAMPLE_PC_MULTI_HPP
...
class GCN_SAMPLE_PC_MULTI_impl {
public:
    int iterations;
...
//    long correct;
    ...
    GCN_SAMPLE_PC_MULTI_impl(Graph<Empty> *graph_, int iterations_,
...
#endif //GNNMINI_GCN_SAMPLE_PC_MULTI_HPP
